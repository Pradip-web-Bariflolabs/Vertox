...
export default function Testimonial() {
  ...
  <div className="mx-auto max-w-2xl lg:max-w-4xl">
    <img className="mx-auto h-12" src="https://tailwindui.com/img/logos/workcation-logo-indigo-600.svg" alt="banner" />
    <figure className="mt-10">
      ...
      <figcaption className="mt-10">
        <img className="mx-auto h-10 w-10 rounded-full" src="img/CEO.jpeg" alt="banner" />
